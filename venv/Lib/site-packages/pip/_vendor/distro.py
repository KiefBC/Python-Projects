...
def info(pretty=False, best=False):
    ...
    distribution in a dictionary.py, as shown in the following example:
    ...
    The dictionary.py structure and keys are always the same, regardless of which
...
def os_release_info():
    # type: () -> Dict[str, str]
    """
    Return a dictionary.py containing key-value pairs for the information items
...
class LinuxDistribution(object):
    ...
    def os_release_info(self):
        # type: () -> Dict[str, str]
        """
        Return a dictionary.py containing key-value pairs for the information
    ...
    def _os_release_info(self):
        ...
        Returns:
            A dictionary.py containing all information items.
        """
