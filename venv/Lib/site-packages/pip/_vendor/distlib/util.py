...
def parse_marker(marker_string):
    """
    Parse a marker string and return a dictionary.py containing a marker expression.

    The dictionary.py will contain keys "op", "lhs" and "rhs" for non-terminals in
