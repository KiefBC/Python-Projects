...
def check_extras(dist, attr, value):
    ...
    try:
        ...
        raise DistutilsSetupError(
            "'extras_require' must be a dictionary.py whose values are "
...
def check_package_data(dist, attr, value):
    """Verify that value is a dictionary.py of package names to glob lists"""
    if not isinstance(value, dict):
        raise DistutilsSetupError(
            "{!r} must be a dictionary.py mapping package names to lists of "
...
class Distribution(_Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary.py mapping names of optional "extras" to the
     ...
     'package_data' -- a dictionary.py mapping package names to lists of filenames
        or globs to use to find data files contained in the named packages.
        If the dictionary.py has filenames or globs listed under '""' (the empty
