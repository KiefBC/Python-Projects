...
# TODO
# change app so it takes a number of questions to generate
# make sure user can specify the range they want to number to come from
# add in further stats to tell you how long it took to answer each questions
